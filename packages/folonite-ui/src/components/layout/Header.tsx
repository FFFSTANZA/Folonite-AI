...
export function Header() {
  ...
  const getLinkClasses = (path: string) => {
    ...
    const activeClasses =
      "bg-folonite-bronze-light-a3 text-folonite-bronze-light-12";
    const inactiveClasses =
      "text-folonite-bronze-dark-9 hover:bg-folonite-bronze-light-a1 hover:text-folonite-bronze-light-12";
  ...
  return (
    <header className="bg-background flex items-center justify-between border-b p-4">
      <div className="flex items-center gap-6">
        ...
        <div>
          {mounted ? (
            <Image
              src={
                resolvedTheme === "dark"
                  ? "/folonite_transparent_logo_white.svg"
                  : "/folonite_transparent_logo_dark.svg"
              }
              alt="Folonite Logo"
              width={100}
              height={30}
        ...
        <div className="border-folonite-bronze-dark-11 h-5 border border-l-[0.5px]"></div>
        <div className="flex items-center gap-2">
          ...
          <Link
            href="https://docs.folonite.ai/quickstart"
            target="_blank"
            rel="noopener noreferrer"
            className={getLinkClasses("https://docs.folonite.ai")}
          >
