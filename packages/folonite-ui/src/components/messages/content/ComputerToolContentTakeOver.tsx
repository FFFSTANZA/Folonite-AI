...
function ToolDetailsTakeOver({ block }: { block: ComputerToolUseContentBlock }) {
  const baseClasses = "px-1 py-0.5 text-xs text-fuchsia-600 bg-folonite-red-light-1 border border-folonite-bronze-light-7 rounded-md";
  ...
  return (
    <div className="max-w-4/5">
      <div className="flex items-center justify-start gap-2">
        ...
        <p className="text-xs text-folonite-bronze-light-11">
          {getLabel(block)}
        </p>
