...
export function ChatContainer({
  ...
  return (
    <div className="bg-folonite-bronze-light-3 flex h-full flex-col">
      {isLoadingSession ? (
        <div className="bg-folonite-bronze-light-3 border-folonite-bronze-light-7 flex h-full min-h-80 items-center justify-center overflow-hidden rounded-lg border">
          <Loader size={32} />
        </div>
        ...
        <>
          ...
          <div className="flex-1">
            ...
            {taskStatus === TaskStatus.RUNNING &&
              control === Role.ASSISTANT && (
                <div className="bg-folonite-bronze-light-3 border-folonite-bronze-light-7 flex items-center justify-start gap-4 border-x px-4 py-3">
          ...
          {[TaskStatus.RUNNING, TaskStatus.NEEDS_HELP].includes(taskStatus) && (
            <div className="bg-folonite-bronze-light-3 z-10 flex-shrink-0">
              <div className="border-folonite-bronze-light-7 rounded-b-lg border-x border-b p-2">
                <div className="bg-folonite-bronze-light-2 border-folonite-bronze-light-7 rounded-lg border p-2">
                  <ChatInput
                    input={input}
                    isLoading={isLoading}
