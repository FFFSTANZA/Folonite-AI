...
// Backend URLs
const FOLONITE_AGENT_BASE_URL = process.env.FOLONITE_AGENT_BASE_URL;
const FOLONITE_DESKTOP_VNC_URL = process.env.FOLONITE_DESKTOP_VNC_URL;
...
app
  ...
  .then(() => {
    ...
    const tasksProxy = createProxyMiddleware({
      target: FOLONITE_AGENT_BASE_URL,
      ws: true,
