...
<p align="center">
  <img
    ...
    src="/logo/folonite_transparent_logo_dark.svg"
    alt="Folonite Logo"
    width="500"
  />
  <img
    className="hidden dark:block"
    src="/logo/folonite_transparent_logo_white.svg"
    alt="Folonite Logo"
    width="500"
  />
</p>
...
Folonite is an open-source AI agent that can control a computer desktop to complete tasks for you. It runs in Docker containers on your own infrastructure, giving you a virtual assistant that can:
...
Simply describe what you need done in plain English, and Folonite will figure out how to do it – clicking buttons, typing text, navigating websites, reading documents, and completing tasks just like a human would.

## Why Folonite Over Traditional RPA?
...
<CardGroup cols={2}>
  ...
  <Card title="Adaptive Intelligence" icon="brain">
    AI-powered understanding means Folonite adapts to UI changes without breaking
  </Card>
...
Folonite is the next generation of RPA (Robotic Process Automation). It handles the same complex workflows as traditional tools like UiPath, but with AI-powered adaptability and automatic authentication:
...
Folonite becomes even more powerful when combined with coding agents:

- **Full-Stack Testing**: Use a coding agent to generate code, then have Folonite visually test and validate the output
- **Automated Debugging**: Let Folonite reproduce user-reported issues while a coding agent analyzes and fixes the code
- **End-to-End Development**: Code agents write features, Folonite tests them, creating a complete development loop
...
<Steps>
  <Step title="Describe Your Task">
    Simply tell Folonite what you want done in natural language through the tasks
    interface
  </Step>
  <Step title="AI Plans the Actions">
    Folonite understands your request and breaks it down into specific computer
    actions
  </Step>
  <Step title="Executes Actions">
    Folonite executes the task on its virtual desktop using the keyboard
    and mouse
  </Step>
...
Folonite consists of four integrated components working together:

<img src="/images/agent-architecture.png" alt="Folonite Agent Architecture" />

<CardGroup cols={2}>
  <Card
    title="Folonite Desktop"
    icon="desktop"
    href="/core-concepts/desktop-environment"
  >
    Ubuntu 22.04 with XFCE4, VSCode, Firefox, Thunderbird email client, and automation daemon (folonited)
  </Card>
...
<CardGroup cols={3}>
  <Card title="Quick Start" icon="rocket" href="/quickstart">
    Get Folonite running in 2 minutes
  </Card>
...
Just tell Folonite what you need done. No coding or complex automation tools required.

### 🖥️ Full Desktop Access
Folonite can use any application you can install - browsers, office tools, custom software.

### 🔒 Complete Privacy
Runs entirely on your infrastructure. Your data never leaves your servers.

### 🔄 Two Operating Modes
- **Autonomous Mode**: Folonite completes tasks independently
...
- **Task View**: Watch and interact with Folonite during task execution
...
<CardGroup cols={2}>
  ...
  <Card
    title="GitHub"
    icon="github"
    href="https://github.com/folonite-ai/folonite"
  >
