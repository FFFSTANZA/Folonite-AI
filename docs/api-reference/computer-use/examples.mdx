...
description: "Code examples for common automation scenarios using the Folonite API"
---
...
await controlComputer("click_mouse", { button: "left" });
    ...
    await controlComputer("type_text", {
      text: "This is an automated test using Node.js and Folonite",
      delay: 30
    });
...
# Write a text file
result = write_file("/home/user/hello.txt", "Hello, Folonite!")
...
Folonite can serve as an alternative to Selenium for web testing:
