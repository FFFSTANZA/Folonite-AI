v---
title: 'Tasks API'
description: 'Reference documentation for the Folonite Agent Tasks API'
---

## Tasks API

The Tasks API allows you to manage tasks in the Folonite agent system. It's available at `http://localhost:9991/tasks` when running the full agent setup.
...
Messages in the Folonite agent system use a content block structure compatible with Anthropic's Claude API:
