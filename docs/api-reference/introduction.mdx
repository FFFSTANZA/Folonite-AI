---
title: "API Reference"
description: "Overview of the Folonite API endpoints for programmatic control"
---

# Folonite API Overview

Folonite provides two main APIs for programmatic control:
