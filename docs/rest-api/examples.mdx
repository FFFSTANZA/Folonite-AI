...
description: "Code examples for common automation scenarios using the Folonite REST API"
---

This page provides practical examples of how to use the Folonite REST API in different programming languages and scenarios.
...
async function fillForm() {
  ...
  await controlComputer("type_text", {
    text: "This is an automated message sent using Folonite's Computer Use API",
    delay: 30,
  });
...
You can create a reusable automation framework with Folonite:
...
class FoloniteDriver:
    """A Selenium-like driver for Folonite"""
