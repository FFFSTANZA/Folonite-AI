...
description: "The virtual Linux desktop where Folonite performs tasks"
---

## Overview

The Folonite Desktop Environment (also called Folonite Core) is a complete Linux desktop that runs in a Docker container. This is where Folonite does its work - clicking buttons, typing text, browsing websites, and using applications just like you would.

<img
  src="/images/core-container.png"
  alt="Folonite Desktop Environment"
