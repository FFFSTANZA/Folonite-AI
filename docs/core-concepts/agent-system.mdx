...
The Folonite Agent System transforms a simple desktop container into an intelligent, autonomous computer user. By combining Claude AI with structured task management, it can understand natural language requests and execute complex workflows just like a human would.

<img
  src="/images/agent-architecture.png"
  alt="Folonite Agent Architecture"
...
At the heart of Folonite is a flexible AI integration that supports multiple models. Choose the AI that best fits your needs:
